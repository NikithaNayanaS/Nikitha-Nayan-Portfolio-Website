        ...
        <div className="relative h-full flex flex-col">
          <div className="relative overflow-hidden h-48">
            ...
            <img
              ...
              alt={title}
              className={`w-full h-full transition-transform duration-700 ${isHovered ? "scale-110" : "scale-100"} object-contain bg-white/5`}
            />
          </div>
          ...
          <div className="p-6 flex-grow flex flex-col">
            ...
            <div className="flex justify-center items-center pt-4 border-t border-zinc-700/50 mt-auto">
              <Button
                variant="ghost"
                size="sm"
                className="text-zinc-400 hover:text-white hover:bg-zinc-700/50 h-9 px-4"
                asChild
              >
